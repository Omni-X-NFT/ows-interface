  ...
  return (
    <div className='w-full main'>
      ...
      <div className='w-full items-center flex-col lg:pt-[150px] pt-[80px]'>
        <div className='flex flex-col lg:flex-row w-full lg:w-5/6 m-auto lg:pb-[180px] pb-20'>
          <div className='lg:w-2/5 w-full px-10 py-5 flex flex-col lg:items-end items-center'>
