              ...
              <div className={sliderstyles.omniSlideWrap}>
                ...
                <div className={sliderstyles.slideContent}>
                  <div className={sliderstyles.slideTxt}>
                    ...
                    <ul>
                      <li style={{ color: "#CCCCCC" }} id="li1">
                        Marketplace
                      </li>
                      <li style={{ color: "#BBBBBB" }} id="li2">
                        Social Interactivity{" "}
                      </li>
                      <li style={{ color: "#AAAAAA" }} id="li3">
                        Deep Analytics
                      </li>
                      <li style={{ color: "#999999" }} id="li4">
                        Curated NFT Launches
                      </li>
                      <li style={{ color: "#888888" }} id="li5">
                        Gaming Integration
                      </li>
                      <li style={{ color: "#777777" }} id="li6">
                        and so much more
                      </li>
                    </ul>
                  </div>
            ...
            <div className={sliderstyles.slideContainer}>
              <div className={sliderstyles.omniSlideWrap}>
                ...
                <div className={sliderstyles.slideContent}>
                  <div className={sliderstyles.slidethreeL}>
                    ...
                    <ul>
                      <li style={{ opacity: "0.7" }}>
                        - for individuals transacting
                      </li>
                      <li style={{ opacity: "0.7" }}>
                        - curve wars style rewards for largest holders
                      </li>
                    </ul>
                  </div>
                  ...
                  <span
                    className={`${sliderstyles.slidetag2} ${sliderstyles.slidetag3}`}
                  >
                    $OMNI
                  </span>
                </div>
